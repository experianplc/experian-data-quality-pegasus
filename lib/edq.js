...
(function () {
    ...
    var PRO_WEB_AUTH_TOKEN = EDQ_CONFIG.PRO_WEB_AUTH_TOKEN;
    var PHONE_VALIDATE_PLUS_AUTH_TOKEN = EDQ_CONFIG.PHONE_VALIDATE_PLUS_AUTH_TOKEN;
    var GLOBAL_PHONE_VALIDATE_AUTH_TOKEN = EDQ_CONFIG.GLOBAL_PHONE_VALIDATE_AUTH_TOKEN;
    var EMAIL_VALIDATE_AUTH_TOKEN = EDQ_CONFIG.EMAIL_VALIDATE_AUTH_TOKEN;
    var GLOBAL_INTUITIVE_AUTH_TOKEN = EDQ_CONFIG.GLOBAL_INTUITIVE_AUTH_TOKEN;
    ...
    var proWebOnPremiseHelper = new _proWebHelpers(PRO_WEB_SERVICE_URL, 'http://www.qas.com/web-2013-12');
